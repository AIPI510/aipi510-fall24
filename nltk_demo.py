...
def feature_engineering_pipeline():
    ...
    tfidf_matrix, feature_names = tfidf_features(texts[:100])  # Use only a subset to save time
...
def test_tokenize_text():
    ...
    assert tokens == ["This", "is", "a", "test", "sentence", "."], "Tokenization failed."
...
def test_tfidf_features():
    ...
    assert tfidf_matrix.shape[0] == 2, "TF-IDF matrix should have 2 rows for 2 documents."
